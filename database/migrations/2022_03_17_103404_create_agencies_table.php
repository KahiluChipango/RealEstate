...
class CreateAgenciesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('agencies', function (Blueprint $table) {
            ...
            $table->enum('master_self_contained', ['YES', 'NO']);
            ...
            $table->enum('guest_house', ['YES', 'NO']);
            $table->enum('pool_house_club', ['YES', 'NO']);
            $table->enum('swimming_pool', ['YES', 'NO']);
            $table->enum('gym', ['YES', 'NO']);
            $table->enum('guard_house', ['YES', 'NO']);
            $table->enum('workers_quarters', ['YES', 'NO']);
            ...
            $table->enum('pets', ['N/A', 'PET FRIENDLY', 'NO PET']);
            ...
            $table->enum('surroundings_facilities_1', ['N/A', 'NEARBY SOCIAL AMENITIES', 'NO NEARBY SOCIAL AMENITIES' ]);
            $table->enum('surroundings_facilities_2', ['N/A', 'SHOPPING MALL', 'SHOPPING CENTRE', 'STAND ALONE SHOP']);
            $table->enum('surroundings_facilities_3', ['N/A', 'SCHOOL', 'NO SCHOOL']);
            $table->enum('surroundings_facilities_4', ['N/A', 'OFFICE BUILDINGS', 'NO OFFICE BUILDINGS']);
            $table->enum('surroundings_facilities_5', ['N/A', 'BUS STATION', 'NO BUS STATION', 'TAXI RANK', 'NO TAXI RANK']);
