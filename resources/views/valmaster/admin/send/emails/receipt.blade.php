                            ...
                            <tbody>
                                <tr>
                                    <td align="center"
                                        ...
                                        <img height="40" src="{{asset('logo/SG Logo.png')}}" alt="Image" width="40" />
                                            <p style="color:white;
            ...
            <tr style="display: inline-block;">
                <td style="height: 150px; padding: 20px; border: none; border-bottom: 2px solid #361B0E; background-color: white;">
                    ...
                    <p class="data" style="text-align: justify-all; align-items: center; font-size: 15px; padding-bottom: 12px;">
                        We have received the payment for the valuation of your property with thanks.
                        <br>Please find attached the receipt.
                    </p>

                    <p>We look forward to doing more with you in the near future. </p>
                </td>
            </tr>
